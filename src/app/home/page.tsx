...
import { Sparkles, BookOpen, Building2, GraduationCap, TrendingUp, MessageSquare } from "lucide-react";
...
export default function Home() {
  return (
    <main className="min-h-screen bg-cream relative">
      ...
      {/* Hero Section */}
      <section className="relative px-4 sm:px-6 pt-12 sm:pt-20 lg:pt-32 pb-16 sm:pb-20 lg:pb-32 flex flex-col items-center text-center">
